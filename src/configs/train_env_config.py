...
#         reward = np.clip(hero_velocity/self.target_speed,0,1.0)*(0.1+0.9*np.dot(agent_vector,target_vector))
#         # reward=(reward + 1) / 2
#         # print(reward,agent_vector,target_vector,imu,heading)
