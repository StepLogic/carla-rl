...
from rllib_integration.helper import post_process_image,carla_location_to_np_array
...
class STBL3GoalExperiment(BaseExperiment):
    ...
    def get_observation_space(self):
        ...
        return Dict({"image":image_space,"goal":goal_image_space, "vector":vec_space})
    ...
    def get_observation(self, sensor_data, core):
        ...
        return {"image":images,"goal":goal, "vector":vecs}, {}
    ...
    def get_done_status(self, sensor_data, core):
        ...
        return self.done_time_idle or self.done_falling or self.done_dist or self.diff_lane or self.collision or distance_to_goal<=1.5
