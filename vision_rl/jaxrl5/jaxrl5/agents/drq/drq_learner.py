...
class DrQLearner(SACLearner):
    ...
    def create(
        ...
        actor_cls = partial(TanhNormal,state_dependent_std=False, base_cls=actor_base_cls, action_dim=action_dim)
    ...
    def update(self, batch: DatasetDict, utd_ratio: int, update_temperature: bool = True,
        ...
        return SACLearner.update(new_agent, frozen_dict.unfreeze(batch), utd_ratio,
